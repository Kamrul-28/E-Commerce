        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel panel-body">
                    ...
                    @endif
                    <form action="" class="form-horizontal" wire:submit.prevent="storeHomeSlider">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input  cols="30" rows="4" placeholder="Price" class="form-control input-md" wire:model="price" /> 
                            </div>   
                        </div> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                @if($image)
                                    <img src="{{$image->temporaryUrl()}}" width="120" height="120"/>
                                @endif
                            </div>   
                        </div>  
